...
def main():
    ...
    # train(config.train_dataPath, config.valid_dataPath, epochs=50, patience=5, loss_fn=GradientRegularizedLoss(config.r, config.alpha, device=config.device), device=config.device)
    # plots('logs/Baseline')
